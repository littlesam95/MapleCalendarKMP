...
class MapleCharacterRepositoryImpl(
    ...
    override suspend fun getCharacters(allWorldNames: List<String>): Flow<ApiState<Map<String, Map<String, List<CharacterSummary>>>>> = flow {
    ...
    override suspend fun fetchFromNexon(apiKey: String, allWorldNames: List<String>): Flow<ApiState<Map<String, Map<String, List<CharacterSummary>>>>> = flow {
        emit(ApiState.Loading)
    ...
    override suspend fun registerCharacters(ocids: List<String>, allWorldNames: List<String>): Flow<ApiState<Map<String, Map<String, List<CharacterSummary>>>>> = flow {
        emit(ApiState.Loading)
    ...
    override suspend fun checkAuthority(ocid: String): Flow<ApiState<Pair<Boolean, Boolean>>> = flow {
        emit(ApiState.Loading)
